import { Injector, Inject, Injectable, Token } from "@adi/core";

import { Override } from "../../src/hooks";

describe('Override hook', function () {
  test('should have possibility to inject custom injections', function() {
    ...
    class Service {
      constructor(
        @Inject(Override(customInjections)) readonly testService: TestService,
      ) {}
    }
  ...
  test('should have possibility to inject custom factory injections', function() {
    ...
    class Service {
      constructor(
        @Inject('foobar', Override(customInjections)) readonly foobar: [HelperService, string],
      ) {}
    }
