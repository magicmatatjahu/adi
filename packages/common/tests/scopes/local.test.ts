import { Injector, Injectable, Inject, Ctx, Context, Scope, STATIC_CONTEXT, ref, OnDestroy, DestroyableType, Destroyable, TransientScope, SingletonScope } from "@adi/core";
