...
export { Config, Decorate, DECORATE_KEY, Delegate, Delegation, DELEGATE_KEY, Factory, Fallback, Inquirer, Lazy, Override, Portal, PORTAL_KEY, Self, SkipSelf, Transform, Value, When } from './hooks';
