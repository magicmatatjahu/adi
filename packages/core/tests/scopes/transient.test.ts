import { Injector, Injectable, Inject, Ctx, Context, Scope, STATIC_CONTEXT, OnDestroy, DestroyableType, Destroyable, Ref, TransientScope, SingletonScope } from "../../src";
...
describe('Transient scope', function () {
  ...
  test('should destroy after calling the method with method injection', async function() {
    ...
    // wait 5ms to resolve all promises in GarbageCollector
