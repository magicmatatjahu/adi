import { Injectable, Module, ref, when, Inject, DynamicModule } from "../../src";
import { Injector } from "../../src/injector/new-injector";
...
describe('Module hierarchy', function() {
  ...
  test('should be able to define two these same modules in imports', function() {
    ...
    @Module()
    class ModuleB {
      static register1(): DynamicModule {
        return {
          extends: ModuleB,
          providers: [
            Service1,
      ...
      static register2(): DynamicModule {
        return {
          extends: ModuleB,
          providers: [
            Service2,
